...
vee::SpriteRendererComponent::SpriteRendererComponent(const Sprite& sprite)
    ...
    pipeline_ = vee::vulkan::PipelineBuilder()
    ...
    vk::DescriptorSetAllocateInfo allocate_info = {
        ctx.descriptor_pool, pipeline_.descriptor_set_layout
    };
    ...
    vk::DescriptorImageInfo image_info = {
        tex_sampler, sprite_.image_->view, vk::ImageLayout::eShaderReadOnlyOptimal
    };

    vk::WriteDescriptorSet descriptor_write = {
        descriptor_set_, 0, 0, vk::DescriptorType::eCombinedImageSampler, image_info, {}, {}
    };
